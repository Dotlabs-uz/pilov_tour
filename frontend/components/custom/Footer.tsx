                    ...
                    <div className="flex gap-10">
                        <div>
                            ...
                            <ul className="space-y-2 text-sm whitespace-nowrap">
                                <li>
                                    <a href="#about" className="hover:text-black">{t("about_us")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("testimonials")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("our_team")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("booking_terms")}</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm whitespace-nowrap">
                                <li>
                                    <a href="#" className="hover:text-black">{t("cancellations")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("privacy_policy")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("sustainability_policy")}</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:text-black">{t("partnership")}</a>
                                </li>
                                <li>
